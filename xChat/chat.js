...
function Chat (filetxt, domainname, fdomainname) {
	file = filetxt;
	domain = domainname;
	fdomain = fdomainname;
	this.init = chatInit;
...
function sendChat(message, nickname) {       
   //alert(fdomain);
   //for faster xchat send
   
   // trial - append the sent msg directly - before actually sent to the server
   //$('#chat-area').append($("<span>" + nickname + " </span><p>"+ message +"</p>"));
	 ...
	 $.ajax({
        ...
        success: function(data) {
        	...
        	if (numOfUsers != data.numOfUsers) {
        		...
        		var list = "<li class='head'>Online Users</li>";
